  ...
  return (
    <div className="w-full flex flex-col gap-4">
        ...
        <div className="h-16 px-6 border-t border-gray-50 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              variant="outline"
              size="sm"
              disabled={!prompt || isPolishing}
              onClick={handleApplePolish}
              className={cn(
            ...
            >
              <Sparkles className={cn("w-3.5 h-3.5 fill-[#0EA5E9]", isPolishing && "animate-spin")} />
      ...
      <div className="flex items-center gap-3 px-4">
         <span className="text-[10px] font-black text-gray-400 uppercase tracking-tighter">Suggestions:</span>
         {["Cyberpunk", "Dungeon Boss", "Magical Item", "UI Icon"].map(tag => (
           <button key={tag} className="text-[10px] font-bold text-gray-500 hover:text-[#0EA5E9] transition-colors">
              #{tag}
           </button>
         ))}
      </div>
