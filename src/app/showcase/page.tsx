        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-8 space-y-8">
          {MOCK_ASSETS.map((asset) => (
            ...
            >
              {/* Image Box */}
              <div
                className={`relative w-full overflow-hidden bg-gradient-to-br ${asset.color} ${asset.size === "v-large" ? "h-[440px]" : "h-[280px]"} flex items-center justify-center transition-all duration-700`}
              >
                ...
                <div className="absolute bottom-6 left-6 right-6 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                  <div className="glass-panel backdrop-blur-xl bg-white/60 p-4 rounded-2xl border-white/50 flex items-center justify-between">
                    ...
                    <Button
                      size="icon"
                      className="w-10 h-10 rounded-xl bg-black hover:bg-[#0EA5E9] text-white transition-all shadow-xl shadow-black/10"
                    >
              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex -space-x-2">
                    ...
                    <div className="flex items-center justify-center w-6 h-6 rounded-full border-2 border-white bg-gray-100 text-[8px] font-bold text-gray-400">
                      +12
                    </div>
                  </div>
      ...
      <section className="mt-32 max-w-5xl mx-auto px-6">
        <div className="glass-panel p-12 md:p-20 rounded-[3rem] bg-gradient-to-br from-gray-900 to-black text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Button
              size="lg"
              className="h-14 px-10 rounded-2xl bg-[#0EA5E9] hover:bg-[#0EA5E9]/90 text-white font-bold text-lg shadow-2xl shadow-[#0EA5E9]/20 gap-3"
            >
