    ...
    <div className="w-full flex-col flex gap-6 pb-20">
      <div className="flex items-center justify-between pb-4 border-b border-border/50">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">设置参数并生成高质量的 2D 游戏资产</p>
        </div>
      </div>

      <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start w-full">
        {/* Left Column: Input & Controls */}
        <div className="lg:col-span-4 xl:col-span-3 flex flex-col gap-6 w-full animate-slide-up" style={{ animationDelay: "50ms" }}>
          ...
          <div className="pt-2">
            <Button size="lg" className="w-full gap-2 shadow-lg h-14 text-md font-semibold">
        ...
        <div className="lg:col-span-8 xl:col-span-9 w-full h-full min-h-125 flex flex-col animate-slide-up" style={{ animationDelay: "100ms" }}>
          <PreviewCard />
        </div>
      ...
      <section className="w-full mt-6 animate-slide-up" style={{ animationDelay: "150ms" }}>
        <h3 className="text-sm font-semibold text-gray-900 mb-4 px-1">当前会话图库</h3>
        <HistoryBar />
      </section>
    </div>
  );
